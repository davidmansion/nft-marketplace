...
const ATTRIBUTES = ["Dana", "Background", "Special"]
            ...
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  ...
                  You can get your URI Link from here
                  https://bscscan.com/address/
                  0x647f2622abb57d18e19e717cfd3fc9754b914c82
                  #readContract#F25
                  Just enter in your NFT number and copy paste the link given.
                </p>
              </div>
            </div>
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <input
                            ...
                            placeholder="https://bafybeih5q3nohokrvd2k3t7fsfdjaqncgy5chcmjtvimx6rnkvapg5cmwi.ipfs.w3s.link/1.json"
                          />
                        </div>
                      </div>
                    </div>
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              <p className="mt-1 text-sm text-gray-600">
                All NFTs now minted please toggle the switch.
              </p>
            </div>
          </div>
          <div className="mt-5 md:mt-0 md:col-span-2">
